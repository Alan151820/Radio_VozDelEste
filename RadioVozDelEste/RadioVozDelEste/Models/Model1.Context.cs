...
namespace RadioVozDelEste.Models
{
    ...
    public partial class Radio_VozDelEsteEntities : DbContext
    {
        public Radio_VozDelEsteEntities()
            : base("name=Radio_VozDelEsteEntities")
        {
        }
        ...
        public virtual DbSet<RegistrosClimaticos> RegistrosClimaticos { get; set; }
